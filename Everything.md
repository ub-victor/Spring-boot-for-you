...
**Services** would be security, transactional, resource pooling, Persistence and so on  **"meta-data"** need which is basically a XML file why would you bother with these sfter all?