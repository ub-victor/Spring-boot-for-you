...
Instean of Manually creating objects using the new keyword, you provide configuration metadata to Spring, and the Framework takes care of the object's enti